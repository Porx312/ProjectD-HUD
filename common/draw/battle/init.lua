...
local draw_battle_players = require("common.draw.battle.players")
local draw_battle_center = require("common.draw.battle.center")
local draw_battle_gap = require("common.draw.battle.gap")
